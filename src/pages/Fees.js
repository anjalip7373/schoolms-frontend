...
const FeeReceipt = ({ receipt }) => (
  <div style={{padding:'32px', fontFamily:'Plus Jakarta Sans, sans-serif', maxWidth:'600px', margin:'0 auto', background: '#fff'}}>
          ...
          <div className="modal" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <div style={{display:'flex', gap:'8px'}}>
                <button className="btn btn-primary btn-sm" onClick={() => downloadFeeReceiptPDF(receipt)}>Download PDF</button>
