...
const Marks = () => {
  ...
  const fetchMarks = async () => {
    ...
    try {
      ...
      // Auto-select first available subject on mobile initialization
  ...
  return (
    <AppLayout title="Marks Entry" subtitle="Enter student marks">
      {/* Viewport Specific Media Breakpoints */}
      <style>{`
        ...
        @media (max-width: 1024px) {
          ...
          .mobile-marks-view { display: block !important; }
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="mobile-marks-view">
            <div className="mobile-subject-banner">
              <div className="mobile-subject-header">
                <h2 className="mobile-subject-title">
          ...
          {/* Persistent Global Action Save Trigger Button */}
